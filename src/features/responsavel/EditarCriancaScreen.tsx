        ...
        <div className={styles.formLayout}>
          <div className={styles.photoCol}>
            <div className={styles.photoCard}>
              ...
              />
              <div className={styles.photoCardName}>{nomeAtual || c.nome}</div>
              <div className={styles.photoCardSub}>
                {[
          ...
          <div className={styles.fieldsCol}>
            <div className={styles.section}>
              <div className={styles.sectionHeadRow}>
                ...
                <span className={styles.sectionNote}>
                  CPF, turma e mensalidade só a secretaria altera
                </span>
              </div>
              <div className={styles.card}>
                <Input
            ...
            <div className={styles.section}>
              ...
              <div className={styles.card}>
                ...
                <div className={styles.readonly}>
                  ...
                  <span>
                    Só a secretaria adiciona um novo responsável. Fale com a
                    escola para incluir alguém.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className={styles.section}>
              ...
              <p className={styles.sectionHint}>
                Alergias e medicações aparecem em destaque na agenda diária e
                para a professora.
              </p>
              <div className={styles.card}>
                <Controller
                ...
                {medicacoes.fields.map((f, i) => (
                  <div key={f.id} className={styles.repeat}>
                    ...
                    <Input
                      label="Medicamento"
                      error={
                        errors.saude?.medicacoesContinuas?.[i]?.nome?.message
                      }
                    ...
                    <Input
                      label="Dose"
                      error={
                        errors.saude?.medicacoesContinuas?.[i]?.dose?.message
                      }
            ...
            <div className={styles.section}>
              ...
              <div className={styles.card}>
                <label className={styles.check}>
                  ...
                  />
                  Autorizo a divulgação de imagens de {c.nome} no mural de
                  fotos.
                </label>
              </div>
            </div>
