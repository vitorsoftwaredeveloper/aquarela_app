...
/** Entrada da tab "Mural" — escolhe a turma antes de ver o mural dela. */
export function MuralTurmasScreen() {
  ...
  usePageTitle("Mural de fotos", `${nome} · escolha a turma`);
          ...
          {turmas.map((t, i) => {
            ...
            return (
              <button
                ...
                onClick={() => router.push(`/professor/turmas/${t._id}/mural`)}
              >
                <span
