          ...
          {turmas.map((t, i) => {
            ...
            return (
              ...
              >
                ...
                <span style={{ flex: 1 }}>
                  <span className={styles.turmaName} style={{ display: "block" }}>
                    Turma {t.nome}
                  </span>
                  <span className={styles.turmaMeta} style={{ display: "block" }}>
                    {t.totalCriancas}{" "}
                ...
                >
                  {emDia ? "Tudo em dia" : `${t.agendasPendentes} pendente${t.agendasPendentes > 1 ? "s" : ""}`}
                </span>
              </button>
            );
          })}
