...
| SIM-05 | 🟡 CTA "Agende uma visita" / captura de lead — **parcial**: `FinalCta.tsx` tem botão pro simulador + link direto de WhatsApp, mas não captura contato estruturado (nome/telefone) num form | 🟢   | 3   | FS     | SIM-03         | Captura contato do interessado — _Fase 2/3_            |
